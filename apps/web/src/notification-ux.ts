...
const TYPE_ICON_MAP: Record<NotificationType, string> = {
    offer_received: 'hand-heart',
    offer_accepted: 'check-circle',
    offer_declined: 'x-circle',
    offer_expired: 'clock',
    connection_started: 'link',
    connection_completed: 'package',
    connection_cancelled: 'unlink',
    lifecycle_changed: 'refresh-cw',
    verification_submitted: 'shield',
    verification_decided: 'shield-check',
    appeal_submitted: 'file-up',
    appeal_decided: 'scale',
    account_expiry: 'calendar-x',
    moderation_action: 'gavel',
    attachment_action: 'paperclip',
    organization_action: 'building',
...
const TYPE_LABEL_MAP: Record<NotificationType, string> = {
    ...
    connection_started: 'Connection',
    connection_completed: 'Completed',
    connection_cancelled: 'Connection Closed',
    lifecycle_changed: 'Request Update',
    verification_submitted: 'Verification',
    verification_decided: 'Verification Decision',
    appeal_submitted: 'Appeal',
    appeal_decided: 'Appeal Decision',
    account_expiry: 'Expiry',
    moderation_action: 'Moderation',
    attachment_action: 'Attachment Review',
    organization_action: 'Organization',
