...
**Execution status:** Completed and deployed on 2026-07-20. Runtime evidence is recorded in `docs/operations/evidence/pds-signup-deployment.md`.
...
- [x] **Step 1: Write service tests for accepted and rejected signup requests**
...
- [x] **Step 3: Implement the bounded signup service**
...
- [x] **Step 4: Add explicit production configuration**

Add `ATPROTO_ACCOUNT_PDS_URL` to the API schema and require the private PDS origin in production Compose. Do not expose this URL as browser build configuration because account creation goes through the API gate and the public PDS route intentionally blocks direct account creation.

- [x] **Step 5: Run the focused service test**
...
- [x] **Step 1: Write route tests for the public contract**
...
- [x] **Step 4: Add the browser API helper**
...
- [x] **Step 1: Add failing rendering and interaction tests**
...
- [x] **Step 1: Add a production Content Security Policy**
...
- [x] **Step 2: Block public direct account creation**
...
- [x] **Step 3: Validate and reload Caddy**
...
- [x] **Step 4: Document the admission boundary**
...
- [x] **Step 2: Commit the reviewed implementation in logical commits**
...
- [x] **Step 3: Back up and deploy**

Take a fresh Patchwork database backup, preserve prior image tags, build images with the current Git SHA, deploy only after migrations succeed, and recreate the API/web services with `ATPROTO_ACCOUNT_PDS_URL` set to the LAN-bound private PDS origin.

- [x] **Step 4: Run non-destructive public smoke tests**
