...
| 15 | P2 | Earlier Phase 7 immutable-delivery evidence recorded 836 tests | Current repository suite has 897 tests | Immutable-delivery evidence refreshed after NUC execution |
